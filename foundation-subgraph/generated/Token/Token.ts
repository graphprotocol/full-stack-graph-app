...
export class Token__getFeesResult {
...
export class Token extends ethereum.SmartContract {
  ...
  getFees(tokenId: BigInt): Token__getFeesResult {
    let result = super.call(
      "getFees",
    ...
    return new Token__getFeesResult(
      result[0].toAddressArray(),
      result[1].toBigIntArray()
    );
  }

  try_getFees(tokenId: BigInt): ethereum.CallResult<Token__getFeesResult> {
    let result = super.tryCall(
      "getFees",
      "getFees(uint256):(address[2],uint256[2])",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
